# Final Bootstrap Script for DoganAI Compliance Kit
# This version handles all issues properly

Write-Host "=== DoganAI Compliance Kit Bootstrap ===" -ForegroundColor Green
...
if ($pyver) {
    ...
    if (Test-Path "main.py") {
        ...
        Write-Host "✓ API server started (main.py)" -ForegroundColor Green
        ...
        Write-Host "✓ API server started (uvicorn)" -ForegroundColor Green
    } else {
...
if ($nodever) {
    ...
    if (Test-Path "package.json") {
        ...
        Write-Host "✓ Web interface started (npm start)" -ForegroundColor Green
    } elseif (Test-Path "frontend/package.json") {
        Set-Location frontend
        Start-Process -WindowStyle Minimized -FilePath "npm" -ArgumentList "start" -RedirectStandardOutput "..\logs\web.out.log" -RedirectStandardError "..\logs\web.err.log"
        Set-Location ..
        Write-Host "✓ Web interface started (frontend)" -ForegroundColor Green
    } else {
